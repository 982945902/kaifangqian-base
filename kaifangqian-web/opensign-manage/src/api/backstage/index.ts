...
enum Api {
  AppList = '/system/sysAppInfo/list',
  AppAdd = '/system/sysAppInfo/add',
  AppUpdate = '/system/sysAppInfo/update',
  DeleteApp = '/system/sysAppInfo/delete',
  AppInfo = '/system/sysAppInfo/info',
  AppVersionList = '/system/sysAppVersion/list',
}
