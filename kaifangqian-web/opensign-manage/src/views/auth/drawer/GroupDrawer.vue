      ...
      <a-card title="" size="small">
        ...
        <div class="auth-group-config-list">
            <div class="auth-group-config-item">
              ...
              <div>
                  <a href="javascript:;" @click="handleAddUser" v-if="hasPermission(['authgroup:addmember'])">设置权限组成员</a>
            ...
            <div class="auth-group-config-item">
              ...
              <div>
                <!-- <a href="javascript:;"  @click="handleRoleUser" v-if="hasPermission(['authgroup:addrole'])">设置角色管理范围</a> -->
                <!-- <a-button type="link"  @click="handleRoleUser" :disabled="rowInfo.groupType=='1' || rowInfo.groupType=='2'">设置角色管理范围</a-button> -->
