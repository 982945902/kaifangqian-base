          ...
          <template v-for="item in list" :key="item.id">
            <a-list-item class="list" @click="handleEdit(item)">
              <a-list-item-meta>
                ...
                <template #avatar>
                  <img
                    src="../../assets/images/taskAvatar.png"
                    style="margin-left: 20px; width: 30px; margin-top: 10px"
                  />
                </template>
                ...
                <template #title>
                  ...
                  <div class="icon-list" style="gap: 10px">
                    <!-- <a-tooltip title="运行记录">
                      <Icon
                        v-if="hasPermission(['task:history'])"
                        icon="ant-design:file-done-outlined"
                        color="#939393"
                        size="20"
                        @click.stop="handleInstance(item)"
                      />
                    </a-tooltip> -->
                    ...
                    <!-- <a-tooltip title="删除任务">
                      <a-popconfirm
                        ...
                        ok-text="是"
                        cancel-text="否"
                        @confirm="handleDeleteInstance(item)"
                      >
                        <Icon
                    ...
                    <!-- <a-tooltip title="删除任务">
                      <Icon
                        ...
                        color="#e11a2d"
                        size="20"
                        @click.stop="handleDeleteInstance(item)"
                      />
                    </a-tooltip> -->
                    <a-tooltip title="执行一次">
                      <Icon
                        v-if="hasPermission(['task:run'])"
                        icon="ant-design:forward-filled"
                        color="#55d187"
                        size="20"
