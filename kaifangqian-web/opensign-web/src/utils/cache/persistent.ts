...
import type { LockInfo, UserInfo, TenantDepartList,TenantInfo,AppInfo,Webconfig } from '/#/store';
...
interface BasicStore {
  ...
  [ROLES_KEY]: string[];
  [TENANT_KEY]: TenantDepartList[];
  [LOCK_INFO_KEY]: LockInfo;
  [PROJ_CFG_KEY]: ProjectConfig;
  [MULTIPLE_TABS_KEY]: RouteLocationNormalized[];
  [APP_LIST_KEY]:AppInfo[];
  [APP_WEB_CONFIG]:Webconfig | null;
}
