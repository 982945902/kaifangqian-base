...
<template>
  <Dropdown placement="bottomLeft" :overlayClassName="`${prefixCls}-dropdown-overlay`" style="top:63px" :trigger="['click']">
    <span :class="[prefixCls, `${prefixCls}--${theme}`]" class="flex">
      <img :class="`${prefixCls}__header__icon`" src="../../../../../assets/images/profile-picture-icon.png" />
