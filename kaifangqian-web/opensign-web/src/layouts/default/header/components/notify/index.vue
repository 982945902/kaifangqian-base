...
<template>
  <div>
    <div :class="prefixCls">
        <Badge :count="count" @click="handleNotice">
...
<script lang="ts">
  ...
  import { computed, defineComponent, ref, h, onMounted, createVNode , render } from 'vue';
  ...
  import { getToken, getLoginToken } from '/@/utils/auth';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      onMounted(()=>{
          fetch()
          // const content1 =  h('span', {domProps: {innerHTML:'<p>fdsfdsfdsfds</p>'}})
          // notification.open({
          //   message: "标题",
          //   description: [h('div', {onClick: () => { console.log("点击事件")} }, convertHTMLToVNode("<p>fdsfdsfdsfds</p>"))],
          //   // description: renderHTMLContent()
          //   duration: null,
          // });
          // notification.open({
          //     duration: null,
