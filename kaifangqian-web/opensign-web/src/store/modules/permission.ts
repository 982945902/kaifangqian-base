...
import { asyncRoutes, ApplicationInsideRoute,AuthLoginRoute, HomeRoute} from '/@/router/routes';
      ...
      switch (permissionMode) {
        ...
        case PermissionModeEnum.BACK:
          ...
          if(getHashQueryString('type') == 'application'){
            ...
            routes = [PAGE_NOT_FOUND_ROUTE, PAGE_INSIDE_LINK, ApplicationInsideRoute, AuthLoginRoute];
          }else{
              ...
              routeList.reverse()
              routes = [PAGE_NOT_FOUND_ROUTE, PAGE_INSIDE_LINK, ...routeList, AuthLoginRoute, HomeRoute];
          } 
          break;
      }
