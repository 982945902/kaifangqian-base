...
enum Api {
  ...
  AppFastList = '/system/SysTenantUserFast/myFast',
  AppFastUpdate = '/system/SysTenantUserFast/update',

  
  setRoleStatus = '/system/setRoleStatus',
  MenuList = '/sys/permission/listMenu',
  MyMenuList = '/sys/permission/getMyMenu',
...
export const getAppFastList = (params) =>
  defHttp.get({ url: Api.AppFastList, params });

export const setAppFastUpdate = (params) =>
  defHttp.put({ url: Api.AppFastUpdate, params });

export const getMyAppsAndMenuList = (params) =>
  defHttp.get({ url: Api.MyMenuList, params });
