  ...
  <div class="activated-container">
    <div class="header">
      ...
      <ul class="description">
        ...
        <li>
          开通服务并完成认证后，您的授权有效期内，允许在本系统中使用您本人的数字证书完成自动静默签署，无需进行签署意愿校验，静默签署时即代表本人的真实签署意愿。
        </li>
      </ul>
    </div>
...
<script lang="ts" setup>
  import { ref } from 'vue';
  import { silentCloseApi, silentQueryRecordApi } from '/@/api/yundun';
  ...
  const viewActivationRecords = async () => {
    ...
    // const result = await silentQueryRecordApi({});
    openModal(true, {});
  };
</script>
