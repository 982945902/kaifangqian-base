    ...
    setup(props:any){
      ...
      function fetch(){
        reload({
          searchInfo:{
           sealId:props.sealId,
           "operateType":[SealRecordType.SealStop,SealRecordType.SealStart]
          }
        });
      }
      onMounted(() => {
