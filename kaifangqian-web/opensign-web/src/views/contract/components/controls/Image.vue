        ...
        <Upload 
          ...
          :showUploadList="false">
            <div v-if="!element.uploadImg">
              ...
              <p style="margin: 0;text-align: center;color:#bfbfbf">图片</p>
            </div>
            <img v-if="element.uploadImg" :src="element.uploadImg" style="width:100%;height:100%;"/>
          </Upload>
    </div>
  </div>
