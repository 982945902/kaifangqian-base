                ...
                <div  class="participants-item-content">
                  <div class="participants-senderUserId-content">
                    <div class="participants-senderUserId-name">
                      ...
                      <span class="weight-label" style="color: #000;font-weight: 600">{{ item.senderType==1?'经办人签字':'组织签章'}}</span>
                      <!-- <div>
                  ...
                  <div class="signatory-action" v-if="signerType !== 2">
  ...
  export default defineComponent({
    ...
    setup(_, { emit }){
      ...
      const [registerModal, { setModalProps, closeModal }] = useModalInner(async (data) => {
        ...
        // recordId.value = data.record?.data.id;
        
        signerType.value = data.record.signerType;
        recordId.value = data.record.data.id?data.record.data.id:data.record.data.uid;
        senderList.value = data.record?.data.senderList?cloneDeep(data.record.data?.senderList):[];
