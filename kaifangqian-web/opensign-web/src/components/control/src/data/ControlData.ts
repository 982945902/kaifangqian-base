...
export function getColtrolByType(type:string):any {
	console.log("baseType:",type,controlList.filter((item:any) => {
...
export const controlList = [
	...
	},
	{
		...
		move:true,
		required:false,
		attr:['name','signer','fontSize','placeholder','value','fontFamily','textAlign'],
		style:{
			fontSize:14,
			fontFamily:"宋体",
			textAlign:"left"
	...
	},
	{
		...
		required:false,
		format:"YYYY年MM月DD日",
		attr:['name','signer','fontSize','format','value','fontFamily','textAlign'],
		style:{
			fontSize:14,
			fontFamily:"宋体",
			textAlign:"left"
