 ...
 * @Last Modified time: 2023-01-07 17:54:52
 */
...
enum Api {
 ...
 AuthAllMenuAuthList = '/sys/permission/listAllTenantAppMenu',
 AuthMenuList = '/sys/permission/listTenantAppMenu',
 AuthTenantMenuAuthData = '/sys/permission/listButtonAndAuth',
 AuthDataChecked = '/system/sysAuthGroupPermission/list',
 AuthDataPerEdit = '/system/sysAuthGroupPermission/edit',


 AuthTenantData = '/system/sysPermissionData/listTenant',
 ...
 //system/sysAuthGroup/listMy
 
}

export function authGroupListMy(params){
...
/**
 * @description: 获取用户目录+菜单+ 权限
 */
export function getAllMenuandAuthTree(params) {
  return defHttp.get({ url: Api.AuthAllMenuAuthList, params });
}
/**
 * @description: 获取用户目录+菜单
 */
export function getAllMenuBtnList(params) {
  return defHttp.get({ url: Api.AuthMenuList, params });
}
/**
 * @description: 获取租户某一菜单下按钮和权限
 */
export function getTenantAppAuthData(params) {
  return defHttp.get({ url: Api.AuthTenantMenuAuthData, params });
}
/**
 * @description: 查询用户拥有的按钮/表单访问权限
 */
export function getAuthData(params) {
  return defHttp.get({ url: Api.AuthTenantData, params });
}
