 ...
 * @Last Modified time: 2023-10-25 15:46:56
 */
...
enum Api {
  ...
  DepartStastics = '/sys/sysDepart/departStastics',
  SendInviteMes = '/sys/sysDepart/batckSendInviteMes',
 ...
 * @description: 组织概览统计
 */
export function getDepartStastics(params) {
  return defHttp.get({ url: Api.DepartStastics,params });
}
/**
 * @description: 组织概览发送提醒
 */
export function getSendInviteMes(params) {
  return defHttp.get({ url: Api.SendInviteMes,params });
}
