...
export const noAuth : AppRouteModule = {
  path:'/noAuth',
  name:'noAuth',
  component: () => import('/@/views/auth/noAuth.vue'),
  meta: {
    title: '没有权限',
  },
}
...
export const basicRoutes = [ExperienceLoginRoute, RootRoute, REDIRECT_ROUTE, PAGE_NOT_FOUND_ROUTE, JoinRoute, MicroForm,noAuth];
