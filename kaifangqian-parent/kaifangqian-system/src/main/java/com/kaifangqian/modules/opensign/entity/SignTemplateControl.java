 ...
 */
@Data
@TableName("sign_template_control")
// @ApiModel("模板控件表")
public class SignTemplateControl extends BaseEntity implements Serializable {


    private static final long serialVersionUID = 4002282005367263859L;
