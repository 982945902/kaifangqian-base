 ...
 * @description: 拒绝填写命令
 */
public class RefuseFillInCmd implements SignCommand<TaskCmdInfo> {
    ...
    public TaskCmdInfo execute(SignCommandContext signCommandContext) {
        ...
        ISysTenantUserService sysTenantUserService = signCommandContext.getSysTenantUserService();
        ...
        signRu.setStatus(SignRuStatusEnum.REJECT_WRITE.getCode());
        ...
        mailDto.setTemplateCode("opensign_contract_wrirte_reject");
        ...
        buttonParaMap.put("contract_wrirte_reject", para);
