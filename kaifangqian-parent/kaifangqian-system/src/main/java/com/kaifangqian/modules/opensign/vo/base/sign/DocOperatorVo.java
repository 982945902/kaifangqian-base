...
/**
 * @Description: DocOperatorVo
 * @Package: com.kaifangqian.modules.opensign.vo.base.sign
 * @ClassName: DocOperatorVo
 * @author: FengLai_Gong
 */
@Data
// @ApiModel("业务线操作人数据对象")
public class DocOperatorVo implements Serializable {

    private static final long serialVersionUID = -8147543446417355341L;
    ...
    // @ApiModelProperty("'操作状态，1为未完成，2为完成'")
