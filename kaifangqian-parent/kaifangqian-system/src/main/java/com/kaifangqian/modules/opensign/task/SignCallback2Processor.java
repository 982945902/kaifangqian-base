...
@Component
@Slf4j
public class SignCallback2Processor implements tech.powerjob.worker.core.processor.sdk.BasicProcessor {
    ...
    public ProcessResult process(TaskContext context) throws Exception {
        ...
        List<ApiCallback> list = apiCallbackService.getByStatus(2);
