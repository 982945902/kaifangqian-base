...
@TableName("tenant_auth_log")
public class TenantAuthLog extends BaseEntity implements Serializable {
     ...
     * 审核意见
     */
    @TableField(value =  "check_msg",updateStrategy= FieldStrategy.IGNORED)
     ...
     * 企业认证方式：legalRep：法定代表人本人认证；invite：法定代表人授权认证，代理人邀请法定代表人在线授权认证；letter：上传授权书认证；
     */
    @TableField("yundun_auth_url")
    private String yundunAuthUrl;
