...
/**
 * @Description: SignEntSeal
 * @Package: com.kaifangqian.modules.opensign.entity
 * @ClassName: SignEntSeal
 * @author: FengLai_Gong
 */
@Data
@TableName("sign_ent_seal")
// @ApiModel("印章信息表")
public class SignEntSeal extends BaseEntity implements Serializable {

    private static final long serialVersionUID = 1686563601017379143L;
